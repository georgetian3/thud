...
get_notifications_success = JDR(status.HTTP_200_OK, 'Get notifications success', models.notification.Notifications)
...
async def delete_notification(notification: models.notification.DeleteNotificationRequest, active_user: ID = Depends(get_active_user)):
