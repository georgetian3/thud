...
// import 'package:thud/models/entity.dart';
...
// class UserList extends EntityOrder<User> {

//   static final userSortCmps = <SortMethod, double Function(User, User)>{


//   };

//   UserList(List<ID> userIds): super(userIds, userSortCmps);
