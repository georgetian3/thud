...
class NotificationTile extends StatelessWidget {
  ...
  @override build(BuildContext context) {
    ...
    return Dismissible(
      key: UniqueKey(),
      onDismissed: (direction) => thudState.deleteNotification(notification.id),
      child: ListTile(
          ...
          if ({'save', 'like', 'comment'}.contains(notification.type)) {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FutureBuilder(
                future: thudState.getPost(notification.content!, refresh: true),
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) => NotificationTile(notifications[notifications.length - index - 1]),
